...
function Asia() {
  ...
  const getCityInformation = (city) => { 
    const cityData = {
      ...
      Japan: {
        image: "./src/assets/img/asia.jpg",
        prices: "$350 per person",     description: "Discover amazing places of the world with us.",
        duration: "3 days",
        person: "2 Person",
        rating: "4.5",
        reviews: "(250)"
    ...
    <div className="container-fluid py-5">
      <div className="container pt-5 pb-3">
        <div className="text-center mb-3 pb-3">
          ...
          <h1>Perfect Tour for Asia </h1>
        </div>
        <div className="row">
          <div className="col-lg-4 col-md-6 mb-4">
            <div className="package-item bg-white mb-2" onClick={()=> openModal('Thailand')}>
              <img className="img-fluid" src="./src/assets/img/tha.jpg" alt="" />
              <div className="p-4">
                <div className="d-flex justify-content-between mb-3">
          ...
          <div className="col-lg-4 col-md-6 mb-4">
            <div className="package-item bg-white mb-2" onClick={()=>openModal('Japan')}>
