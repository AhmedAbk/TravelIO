...
function Us() {
  ...
  const getCityInformation = (city) => { 
    const cityData = {
      Miami: {
        image: "./src/assets/img/united states.jpg",
      ...
      <div className="container-fluid py-5">
        <div className="container pt-5 pb-3">
          <div className="text-center mb-3 pb-3">
            ...
            <h1>Perfect Tour for United States</h1>
          </div>
          <div className="row">
            <div className="col-lg-4 col-md-6 mb-4">
              <div className="package-item bg-white mb-2" onClick={() => openModal('Miami')}>
            ...
            <div className="col-lg-4 col-md-6 mb-4">
              <div className="package-item bg-white mb-2" onClick={() => openModal('Los Angeles')}>
                <img className="img-fluid" src="./src/assets/img/la.jpg" alt="" />
                <div className="p-4">
                  <div className="d-flex justify-content-between mb-3">
                    <small className="m-0"><i className="fa fa-map-marker-alt text-primary mr-2" />Los Angeles</small>
                    <small className="m-0"><i className="fa fa-calendar-alt text-primary mr-2" />3 days</small>
                    <small className="m-0"><i className="fa fa-user text-primary mr-2" />2 Person</small>
                  </div>
                  <a className="h5 text-decoration-none" href>Discover amazing places of the world with us</a>
